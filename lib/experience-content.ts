    ...
    {title:'Home Theater',description:'Enjoy a dedicated cinema experience with projection, surround sound, acoustic treatment and coordinated lighting.',image:{src:'/images/projects/home-theater-supplied.webp',alt:'Supplied home theatre with recliners, projector and acoustic wall panels',ratio:'3/4'}},
    ...
    {category:'RESIDENTIAL · AUTOMATION',slug:'connected-villa',title:'Connected Villa',description:'Whole-home automation designed around everyday routines, intelligent lighting, climate control and seamless access.',image:{src:'/images/projects/connected-villa-supplied.webp',alt:'Connected Villa with timber facade, black entrance gates and perimeter security fencing',ratio:'4/3'}},
    {category:'RESIDENTIAL · SECURITY',slug:'intelligent-home-security',title:'Intelligent Home Security',description:'Integrated access, smart locks, video door phones and surveillance for secure and effortless living.',image:{src:'/images/projects/security-entrance-cctv.webp',alt:'Illustrative CCTV camera overlooking a residential entrance',ratio:'3/2'}},
    {category:'HOME THEATRE · ENTERTAINMENT',slug:'private-home-cinema',title:'Private Home Cinema',description:'A dedicated entertainment environment combining projection, audio, lighting and motorized curtains.',image:{src:'/images/projects/home-theater-supplied.webp',alt:'Home theatre with recliners and a ceiling projector',ratio:'3/4'}},
    ];
